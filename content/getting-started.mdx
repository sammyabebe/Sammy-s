---
title: "Getting Started with Sammy's"
publishedAt: "2024-08-13"
summary: "Instructions to build and configure your Nextfolio portfolio."
tags: "Configuration, Web development"
---

Sammy's includes all the essentials for a stunning portfolio website.

Start by [deploying](https://github.com/sammyabebe/my-portfolio/blob/main) and follow the instructions below to set it up.

[![Deploy with Vercel](https://vercel.com/button)](https://my-portfolio-jj4h.vercel.app/)

## Installation

Sammy's uses [pnpm](https://pnpm.io/installation) for dependency management, so ensure it is installed on your system.
...
export const metaData = {
  baseUrl: "https://my-portfolio-jj4h.vercel.app/", // Update with your site base URL
  title: "Sammy's", // Update with your site title
...
Sammy's uses [Vercel Web Analytics](https://vercel.com/docs/analytics/quickstart) and [Speed Insights](https://vercel.com/docs/speed-insights/quickstart) to monitor user interactions and website's performance. Simply deploy your site on Vercel and enable both features through the Vercel dashboard.
